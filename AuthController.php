	...
	function idenAlumnoAction ()
	{
		...
		if ($this->_request->isPost()) {
	       ...
	       $lsInputCaptcha = (trim($this->_request->getPost('input_captcha'))=='')?0:
            ...
            /*
             * Comentareado para evitar el capcha solo para pruebas
...
//	        	else{
                    ...
                    */
                    ...
                    $webService->getHttpClient()->setAuth('cepsistemas', 'ZOpU7MFr8vXV7OE6c8cMui71IIYDESFaZ9FAjml8', Zend_Http_Client::AUTH_BASIC);
                    ...
                    //if (($usuarioWebService) && ($passWebService)) {
                        ...
                        $webService->arg8('programa'); // mo viene dato del webService original*/
                        $resultadoWeb = $webService->get();

                   
						                   
                  //die("Se declararon var de ResT");
                    //}
                        echo $url_webService."<br>"; 
                        //echo $resultadoWeb -> cuenta();
                    print_r($resultadoWeb);
                    if($resultadoWeb->isSuccess()){
                        echo("Se conecto bien");
                        echo $resultadoWeb -> cuenta();
                    }else{
                        echo("No se conecto bien");
                    }
                    exit;
                    //
